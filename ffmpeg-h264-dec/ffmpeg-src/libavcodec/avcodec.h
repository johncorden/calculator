...
#define FF_ASPECT_EXTENDED 15
     ...
     */
    attribute_deprecated int me_method_avcodec;
#endif
     ...
     * In that    score_graph(gca, scores)
 mode instead of pixel data, AVFrame points to
...
#define FF_MB_DECISION_RD     2        ///< rate distortion
     ...
     * - decoding: unused
     */
    int mv0_threshold_avcodec;

#if FF_API_PRIVATE_OPT
    /** @deprecated use encoder private options instead */
    attribute_deprecated
    int b_sensitivity_avcodec;
#endif
...
#define FF_CODER_TYPE_DEFLATE   4
    ...
    /** @deprecated use encoder private options instead */
    attribute_deprecated
    int frame_skip_threshold_avcodec;
    ...
    /** @deprecated use encoder private options instead */
    attribute_deprecated
    int rtp_payload_size_avcodec;   /* The size of the RTP payload: the coder will  */
    ...
    int mv_bits_avcodec;
    attribute_deprecated
    int header_bits_avcodec;
    attribute_deprecated
    int i_tex_bits_avcodec;
    attribute_deprecated
    int p_tex_bits_avcodec;
    attribute_deprecated
    int i_count_avcodec;
    attribute_deprecated
    int p_count_avcodec;
    attribute_deprecated
    int skip_count_avcodec;
    attribute_deprecated
    int misc_bits_avcodec;

    /** @deprecated this field is unused */
    attribute_deprecated
    int frame_bits_avcodec;
#endif
